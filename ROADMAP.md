...
- **M3 — Web submission and moderation infrastructure:** only after the local curation and dataset models prove stable; prospective scope includes a submission API/UI, authentication, durable audit storage, and deployment safeguards.
